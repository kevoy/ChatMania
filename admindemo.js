...
window.onload = function(){
	...
	alert("Because this is a demo editing and deleting features are disabled. \nWhen you purchase this website you'll be able to make changes");
}
...
function saveSettings(){
	...
	var adsv = document.getElementById('ads-code-vertical').value;
